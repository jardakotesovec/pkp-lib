        ...
        >
            ...
            {if $localeKey === $submission->getData('locale')}
                ...
                <div class="submissionWizard__reviewPanel__item">
                    ...
                    <template
                        v-if="
                            errors.dataCitations ||
                            (publication.dataCitations && publication.dataCitations.length === 0 && {$isRequired})
                        "
                    >
                        <notification
                            v-for="(error, i) in (errors.dataCitations || ['{translate key="submission.dataCitations.required"}'])"
                            :key="i"
                            type="warning"
                        >
                    ...
                    <div class="submissionWizard__reviewPanel__item__value">
                        ...
                        <div
                            v-else
                            v-for="(citation, i) in publication.dataCitations"
                            :key="i"
