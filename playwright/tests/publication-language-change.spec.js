...
/**
 * Publication primary-language change — row 3 of
 * docs/e2e/plans/publication-versioning.md (originally row #33 in
 * docs/e2e-playwright-migration.md; moved here from playwright/tests/
 * per the plan's lib/pkp placement — the change-language widget is the
 * shared WorkflowChangeSubmissionLanguage component).
 *
